import Nav from './Nav';
const problems = [
    {header:'비밀번호를 알아내자',hint:'정답은 언제나 문제 속에 있습니다',contents:'진우는 평소 개인정보보호에 관심이 많은 편입니다. 이번 대회의 첫번째 입장 비밀번호를 정하기 위해 많은 고민을 한 결과, 대회 입장 비밀번호를 어떠한 ‘비밀번호’로 설정하였습니다. 개인정보보호에 관심이 많은 진우는 과연 어떤 비밀번호를 고안하였을까요?'},
    ...
    {header:'Nah....',hint:'직접 시도해보세요..!',contents:''},
]
